#!/usr/bin/env node
/**
 * Gera a migração 0094 — a palavra mais rara e o aproveitamento.
 *
 * Uso: node scripts/gera-letreiro-estatisticas.mjs
 */
...
function troca(de, para, onde) {
  if (!premia.includes(de)) throw new Error(`não achei ${onde}`);
...
writeFileSync("supabase/migrations/0094_letreiro_estatisticas.sql", sql, "utf8");
console.log("0094 gerado");
