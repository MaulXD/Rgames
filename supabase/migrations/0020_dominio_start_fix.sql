-- ═══════════════════════════════════════════════════════════════════════════
-- Mesa — 0020 · conserta dominio_start
--
-- Dois problemas, um óbvio e um sutil.
--
-- 1. `column reference "seat" is ambiguous`. A variável PL/pgSQL chamava-se
--    `seat`, igual à coluna de room_members e match_players. Toda consulta que
--    mencionava `seat` ficou ambígua e a função não rodava nem uma vez.
--    Regra daqui em diante: variável de PL/pgSQL não usa nome de coluna.
--
-- 2. O objetivo secreto era sorteado por jogador, com hash independente — dois
--    jogadores podiam receber o MESMO objetivo. Num jogo em que o objetivo é a
--    condição de vitória, isso é uma partida com dois vencedores possíveis pelo
--    mesmo caminho. Agora os índices são embaralhados e distribuídos sem
--    repetição.
-- ═══════════════════════════════════════════════════════════════════════════
