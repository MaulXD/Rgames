-- ════════════════════════════════════════════════════════════════════════════
-- Mesa — 0066 · o leilão da máquina converge em vez de subir de degrau
--
-- Numa mesa com duas máquinas, um leilão levava vinte e quatro lances: a firme
-- cobria o mínimo, a impiedosa somava duzentos, e as duas subiam juntas até o
-- teto de avaliação.
--
-- Contado em passos, com o respiro de 900ms que o cliente dá entre um e outro,
-- isso é mais de VINTE SEGUNDOS de máquina lançando contra máquina enquanto a
-- pessoa só assiste. Leilão que não se assiste é leilão que se pula — e pular o
-- leilão é pular a parte da Metrópole em que uma propriedade recusada muda de
-- dono por um preço que ninguém esperava.
--
-- Agora cada lance fecha uma FRAÇÃO do que falta até o teto, então o mesmo
-- leilão termina em cinco ou seis: cada lance diz alguma coisa, e o último ainda
-- é uma decisão.
--
-- E a fração é também o nível — a tranquila cobre o mínimo e espera, a firme
-- fecha um terço, a impiedosa fecha metade e assusta quem ia subir. É o mesmo
-- comportamento de gente numa mesa de verdade, e é de graça: o número que
-- define a agressividade já estava ali, só era fixo.
-- ════════════════════════════════════════════════════════════════════════════
